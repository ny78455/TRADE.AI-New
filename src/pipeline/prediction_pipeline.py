...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            numerical_columns = ["Year", "Month", "Day", "Hour", "Minute", "EMASignal", "isPivot", "Position", "ordersignal", "EMASignal1", "martiangle_signal"]

            categorical_columns = ["CHOCH_pattern_detected", "fibonacci_signal", "SL", "TP", "MinSwing", "MaxSwing", 
                                   "LBD_detected", "LBH_detected", "SR_signal", "isBreakOut", "candlestick_signal", 
                                   "result", "signal1", "buy_signal", "sell_signal", "fractal_high", "fractal_low", 
                                   "buy_signal1", "sell_signal1", "fractals_high", "fractals_low", "VSignal", "PriceSignal", 
                                   "TotSignal", "SLSignal", "grid_signal", "SLSignal_heiken", "long_signal", "Candle_direction"]
